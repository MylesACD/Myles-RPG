...
from . import views
from .views import TechniqueListView, TechniqueDetailView, TechniqueCreateView, TechniqueUpdateView, TechniqueDeleteView, UserTechniqueListView, TechniquePublicView
...
urlpatterns =[
        ...
        path("redirect/<slug:slug>/",TechniquePublicView.as_view(), name="public-redirect"),
